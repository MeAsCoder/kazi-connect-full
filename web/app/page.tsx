...
const TRADES = [
  "Plumbers", "Electricians", "Masons", "Painters", "Welders", "Carpenters",
  "Cleaners", "Drivers", "Mechanics", "Beauticians", "Chefs", "Gardeners",
  "Tutors", "Nannies", "Movers", "Photographers", "Tailors", "Appliance repair",
];
...
const STAGES = [
  { icon: "📝", title: "Describe", sub: "plain words", tech: "your words", fill: "#1F1B16" },
  { icon: "🧠", title: "Detect trade", sub: "AI model", tech: "understands intent", fill: "#C65A2E" },
  { icon: "🗄️", title: "Find pros", sub: "of that trade", tech: "verified profiles", fill: "#1A6B45" },
    ...
    <div>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 pb-12 pt-10 md:grid-cols-2 md:pt-16">
          <div className="animate-fadeUp">
            ...
            <h1 className="font-display text-5xl font-extrabold leading-[1.05] tracking-tight md:text-6xl">
              Find a trusted <span className="text-acacia">pro</span> near you, fast.
            </h1>
            ...
            <div className="card mt-8 flex flex-col gap-2 p-2 sm:flex-row">
              ...
              <Link href="/register" className="btn-primary justify-center">Find a pro</Link>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-14">
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted">
            ...
            ranked shortlist of pros you can contact in seconds.
          </p>
        </div>
        ...
        <div className="card overflow-x-auto p-6">
          <svg viewBox="0 0 920 230" className="mx-auto block min-w-[680px] max-w-full" role="img" aria-label="Kazi Connect request pipeline">
            ...
            <text x={20} y={40} fontSize={14} fill="#857C6E">your request → AI understanding → matching → ranking → results</text>
            <defs>
      ...
      <section className="mx-auto max-w-6xl px-6 py-14">
        <div className="grid gap-5 md:grid-cols-2">
          <div className="card p-7">
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              {["Plain-language search — no forms or jargon",
                "See why each pro was matched, factor by factor",
          ...
          <div className="card p-7">
            <span className="chip mb-3 border-clay/40 bg-clay-soft text-clay">For pros</span>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="card relative overflow-hidden bg-acacia p-10 text-center md:p-12">
          ...
          <div className="relative">
            <h2 className="font-display text-3xl font-bold text-white md:text-4xl">Ready to find your next pro?</h2>
            <p className="mx-auto mt-3 max-w-md text-acacia-soft">Join Kazi Connect today — it&apos;s free to get started.</p>
            <div className="mt-7 flex flex-wrap justify-center gap-3">
              <Link href="/register" className="btn bg-white text-acacia-dark hover:bg-paper">Hire a pro</Link>
      ...
      <footer className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="grid grid-cols-1 gap-8 pt-8 md:grid-cols-4">
          <div>
            <Logo />
            <p className="mt-3 text-sm text-muted">Connecting Nairobi with trusted pros through transparent, AI-powered matching.</p>
          </div>
          <div>
