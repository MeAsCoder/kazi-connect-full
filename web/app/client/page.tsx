  ...
  return (
    <div className="grid gap-8 lg:grid-cols-5">
      ...
      <div className="lg:col-span-2">
        ...
        <p className="mb-5 text-muted">Describe it in plain words — we&apos;ll find the right pro.</p>
        ...
        {!busy && !workers && (
          <div className="card grid h-full min-h-[320px] place-items-center p-8 text-center">
            <div>
              ...
              <p className="text-sm text-muted">Post a job to see the best pros near you.</p>
            </div>
          </div>
        )}
      </div>
